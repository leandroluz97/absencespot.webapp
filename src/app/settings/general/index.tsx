...
export const General = () => {
    return (
        <div className="flex-1 bg-white max-w-6xl rounded-lg h-auto md:h-full overflow-hidden p-2">
            <div className="p-6 h-full overflow-y-auto text-sm space-y-6">
                <header>
                ...
                <section className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                            ...
                            >
                                Don't show the leave type in calendars, daily and weekly
                                notifications or other places visible to the whole organization.
                            </LabelPrimitive.Label>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                            <LabelPrimitive.Label
                                ...
                                className="select-none text-sm font-medium text-slate-400 max-w-2xl"
                            >
                                Send email notifications (disable for example if you only want to
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                            <LabelPrimitive.Label
                                ...
                                className="select-none text-sm font-medium text-slate-400 max-w-2xl"
                            >
                                Approve/reject links from emails should only work if you are logged
                                in.
                            </LabelPrimitive.Label>
                            <SwitchPrimitive.Root
                                id="login"
