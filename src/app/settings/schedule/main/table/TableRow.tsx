    ...
    return (
        <Table.Row className="p-2 bg-slate-50 rounded-lg">
            <Table.Column className="col-span-4">
                <p className="text-slate-500 text-sm">Full-time - 40h</p>
            </Table.Column>
            <Table.Column className="col-span-2">
                <p className="text-slate-500 text-sm">40h</p>
            </Table.Column>
            <Table.Column className="col-span-2">
                <p className="text-slate-500 text-sm">Flexible</p>
            </Table.Column>
            <Table.Column className="col-span-2">
                <p className="text-slate-500 text-sm">16</p>
            </Table.Column>
